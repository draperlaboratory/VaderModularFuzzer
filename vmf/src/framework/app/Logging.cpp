 ...
 * by the Vader application during initialization.  Individual users of the
 ...
 * This should be called by Vader application during intialization.
...
void Logging::init(ConfigInterface& config)
{
    ...
    VaderUtil::createDirectory(dir.c_str());
