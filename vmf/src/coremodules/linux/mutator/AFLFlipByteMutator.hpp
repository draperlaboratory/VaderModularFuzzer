...
{
/**
 * @brief This mutator flips a random byte in the test case buffer
 * 
 ...
 */
class AFLFlipByteMutator: public MutatorModule
{
public:
    ...
    AFLFlipByteMutator(std::string name);
    virtual ~AFLFlipByteMutator();
