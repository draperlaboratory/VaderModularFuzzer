...
{
/**
 * @brief This mutator flips a random single bit in the test case buffer
 * 
 ...
 */
class AFLFlipBitMutator: public MutatorModule
{
public:
    ...
    AFLFlipBitMutator(std::string name);
    virtual ~AFLFlipBitMutator();
