...
{
/**
 * @brief This mutator flips a random pair of bytes in the test case buffer
 * 
 ...
 */
class AFLFlip2ByteMutator: public MutatorModule
{
public:
    ...
    AFLFlip2ByteMutator(std::string name);
    virtual ~AFLFlip2ByteMutator();
