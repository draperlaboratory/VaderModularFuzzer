 ...
 */
Array* vmf::slice(Array* input, int idx) {
    terminal* origptr;
 ...
 */
Array* vmf::carve(Array* input, int start, int end) {
    terminal* origptr;
 ...
 */
void vmf::concatPrefixFeature(Array* prefix, Array* feature) {
 ...
 */
void vmf::initArray(Array* a, size_t initialSize) {
 ...
 */
Array* vmf::spliceGF(Array* orig, Array* toSplice, int idx) {
 ...
 */
void vmf::insertArray(Array *a, int state, char* symbol, size_t symbol_len, int trigger_idx) {
 ...
 */
char* vmf::unparse_walk(Array* input) {
    terminal* term_ptr;
    size_t offset = 0;
 ...
 */
Array* vmf::read_input(pdaState* pda, char* buffer) {
    terminal *term;
    pdaState *state_ptr;
    trigger *trigger;
    int trigger_idx;
